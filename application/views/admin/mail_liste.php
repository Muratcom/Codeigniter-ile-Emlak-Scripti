        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Mail Kutusu</li>
            </ul>
			
			  
			  	<table class="table table-condensed">
 <tr><td><b>konu</td><td><b>detay</td><td><b></td><td><b></td>
			 <?php
			 
foreach($veri2 as $rs2)
	{
		echo "<tr><td>".$rs2->baslik ."</td>"."<td>".$rs2->detay ."</td>"."<td><span class='badge bg-red'>"."<a href='sil_mail/".$rs2->id."'> SİL </a>"."</td></span>"."<td><span class='badge bg-red'>"."<a href='duzenle_mail/".$rs2->id."'> DUZENLE </a>"."</td></span>"."</tr> ";
