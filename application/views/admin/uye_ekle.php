...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>Ogrenci/cms" class="logo">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i><b> <u>Üye Ekleme Sayfası</u></li>
            </ul>
			
						<table class="table table-condensed">
                 
			 <?php
 echo "<tr><td>".form_open(base_url().'ogrenci/uye_ekle_2')."</td></tr> ";

 //echo form_open(base_url().'ogrenci/uye_ekle_2');
 
   echo "<tr><td>".form_label('İsim:')."</td>"."<td>".form_input(array('id'=>'numara','name'=>'isim'))."</td></tr> ";
   //echo form_input(array('id'=>'numara','name'=>'isim'));
   echo "<br>";
   echo "<tr><td>".form_label('Cinsiyet:')."</td>"."<td>".form_input(array('id'=>'adsoy','name'=>'cinsiyet'))."</td></tr> ";

  // echo form_label('Cinsiyet:');
   //echo form_input(array('id'=>'adsoy','name'=>'cinsiyet'));
   echo "<br>";
   
   echo "<tr><td>".form_label('Yas:')."</td>"."<td>".form_input(array('id'=>'yas','name'=>'yas'))."</td></tr> ";

   //echo form_label('Yas:');
   //echo form_input(array('id'=>'yas','name'=>'yas'));
   echo "<br>";
   
   echo "<tr><td>".form_label('Mail Adresi:')."</td>"."<td>".form_input(array('id'=>'mail','name'=>'mail'))."</td></tr> ";

  // echo form_label('Mail Adresi:');
  //echo form_input(array('id'=>'mail','name'=>'mail'));
   echo "<br>";
   
   echo "<tr><td>".form_label('Sifre:')."</td>"."<td>".form_input(array('id'=>'sifre','name'=>'sifre'))."</td></tr> ";

   //echo form_label('Sifre:');
   //echo form_input(array('id'=>'sifre','name'=>'sifre'));
   echo "<br>";
   echo "<br>";
    echo "<tr><td>".form_submit(array('id'=>'submit','value'=>'Üyeyi ekle'))."</td></tr> ";

  // echo form_submit(array('id'=>'submit','value'=>'Üyeyi ekle'));
