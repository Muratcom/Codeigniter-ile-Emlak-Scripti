        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> İlanlar Tablosu</li>
            </ul>
			
			
			<table class="table table-condensed">
 <tr>
 <td><b>baslık</td><td><b>detay</td><td><b>fiyat</td><td></td><td></td>
  <?php
			 
foreach($veri as $rs)
	{
	//echo "<a href='ogrenci/sil/".$rs->id."'> SİL </a>"; // Normal link oluşturma
	echo "<tr><td>".$rs->baslik ."</td>"."<td>".$rs->detay ."</td>"."<td>".$rs->fiyat."TL</td>"."<td><span class='badge bg-red'>"."<a href='sil/".$rs->id."'> SİL </a>"."</td></span>"."<td><span class='badge bg-red'>"."<a href='duzenle/".$rs->id."'> DUZENLE </a>"."</td></span>"."</tr> ";
