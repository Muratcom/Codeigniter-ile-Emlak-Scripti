            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url();?>Ogrenci/logout" >Sign out</a>
                </div>
              </li>
            </ul>
          </li>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li class="pull-left header"><i class="fa fa-inbox"></i> Üyeler Tablosu</li>
            </ul>
			
			<table class="table table-condensed">
				
 <tr><td><b>isim</td><td><b>cinsiyet</td><td><b>mail </td><td><b>sifre</td><td></td><td></td>
			 <?php
			 
foreach($veri1 as $rs1)
	{
	echo "<tr><td>".$rs1->isim ."</td>"."<td>".$rs1->cinsiyet ."</td>"."<td>".$rs1->mail."</td>"."<td>".$rs1->sifre ."</td>"."<td><span class='badge bg-red'>"."<a href='sil_uye/".$rs1->id."'> SİL </a>"."</td></span>"."<td><span class='badge bg-red'>"."<a href='duzenle_uye/".$rs1->id."'> DUZENLE </a>"."</td></span>"."</tr> ";
